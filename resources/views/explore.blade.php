@extends('layouts.profile') <!-- or your base layout -->
            ...
            <div class="explore-content">
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        @endphp
                        <div class="card mb-2 p-2" id="user-{{ $user->id }}">
                            <div class="d-flex justify-content-between align-items-center">
                                <div class="d-flex align-items-center">
                                    <!-- Link to user's feed (stalk) -->
                                    <a href="{{ route('user.feed', ['user' => $user->id]) }}" class="d-flex align-items-center">
                                        <!-- Display user's profile picture -->
                                        <img src="{{ $userProfileImage }}" alt="Profile Picture" class="img-fluid rounded-circle" width="40" height="40">
